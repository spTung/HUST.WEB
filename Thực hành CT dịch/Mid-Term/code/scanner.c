...
Token* readNumber(void) { // Integer + Double
  int ln, cn;
...
Token* readConstChar2(void) { // Get String Token
...
Token* getToken(void) {
  ...
  case CHAR_SINGLEQUOTE: return readConstChar(); // Char
  case CHAR_DOUBLEQUOTE: return readConstChar2(); // String
  case CHAR_LPAR:
    ln = lineNo;
    cn = colNo;
    readChar();
