...
ConstantValue* compileUnsignedConstant(void) { // (1)
...
ConstantValue* compileConstant(void) { // (1)
  ConstantValue* constValue;
...
ConstantValue* compileConstant2(void) { // (1)
  ConstantValue* constValue;
  Object* obj;
...
void compileIndexes(void) {
  while (lookAhead->tokenType == SB_OPEN_BRACKET) {
    eat(SB_OPEN_BRACKET); // (1)
    compileExpression();
    eat(SB_CLOSE_BRACKET); // (1)
  }
}
